...
class TeacherMeetingItem extends StatelessWidget {
  final Meeting meeting;

  const TeacherMeetingItem(this.meeting);
    ...
    return Dismissible(
        ...
        return showDialog(
            ...
            builder: (ctx) {
              return AlertDialog(
                ...
                content: Text('Are you sure to delete lecture ?'),
                actions: <Widget>[
                  FlatButton(
                      onPressed: () {
      ...
      onDismissed: (direction) {
        if (direction == DismissDirection.endToStart) {
         Provider.of<MeetingsManager>(context,listen: false).removeMeeting(meeting.id);
        }
      },
      child: Container(
