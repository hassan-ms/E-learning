...
final isValid=_formKey.currentState.validate() &&(_files.isNotEmpty||_link!=null);
if(!isValid){
  return;
}
setState(() {
...
final gfiles=await Provider.of<ClassroomManager>(context).uploadFiles(_files);
...
await Provider.of<ClassroomManager>(context).addAnnouncement(courseId:'148352686559', announce: announcement);
      ...
      child: Scaffold(
        body: Stack(
          ...
          Container(
            ...
            child: Opacity(
              opacity: 0.8,
              child: Image.asset('assets/icons/bookstack.png',height: 200,)),),
            ...
            child: Column(
              children: <Widget>[
                ...
                Row(
                  ...
                  children: [
                    Image.asset('assets/icons/graduate.jpg',width: 50,),
                    Container(
                        ...
                        child: Column(
                          children: [
                            ListTile(
                              ...
                              title: Text('Link'),
                              subtitle: Text(' drive file link , youtube video or any other link'),
                              leading: Image.asset(
                            ...
                            AnimatedContainer(
                              ...
                              child:drive_drop? TextFormField(
                        ...
                        child: FlatButton(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Image.asset('assets/icons/upload.png',width: 25,),
                                Text(
                                  '  Upload',
                                  style: TextStyle(
                                      color: Colors.blue,
